...
export default function DummyPost() {
    return (
        <div className="dummy relative overflow-hidden flex-shrink-0 w-full border-2 border-transparent hover:border-themeMain rounded-md p-3 dark:bg-dark-themeBackground/90 bg-white/90 backdrop-blur-md flex flex-col gap-3">
